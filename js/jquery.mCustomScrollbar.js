			...
			return this.each(function(){
				...
				if(!$(document).data("mCS-is-touch-device")){ /*not touch device - apply custom scrollbars functionality*/
					...
					if(options.scrollButtons.enable){
						if(options.horizontalScroll){
							mCSB_scrollTools.prepend("<a class='mCSB_buttonLeft' style='display:none; position:relative;'></a>").append("<a class='mCSB_buttonRight' style='display:none; position:relative;'></a>");
						}else{
							mCSB_scrollTools.prepend("<a class='mCSB_buttonUp' style='display:none; position:relative;'></a>").append("<a class='mCSB_buttonDown' style='display:none; position:relative;'></a>");
						}
					}
